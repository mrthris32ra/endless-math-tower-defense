...
window.onload = function() {
  ...
  path = [
    createVector(0, 80), createVector(30, 80), createVector(80, 115), createVector(40, 150), createVector(40, 215), 
    createVector(90, 215), createVector(125, 185), createVector(160, 215), createVector(160, 350), createVector(50, 350), 
    createVector(50, 480), createVector(255, 480), createVector(235, 530), createVector(325, 530), createVector(305, 455), 
    createVector(450, 455), createVector(450, 300), createVector(350, 300), createVector(350, 395), createVector(260, 395),
    createVector(260, 210), createVector(550, 210), createVector(670, 350), createVector(670, 0)
  ];
